...
- Users can choose from three different themes (more to come) to customize the look of their blog. 
...
- Added a ton of chat functionality, chat conversations persist after logging out, refreshing the page, or closing out of the browser. Fixed up a ton of code related to chat
...
- Add ability to post several pictures in one post. Add ajax image upload to WYSIWYG editor
- **Picture upload through chat**
- **Some kind of API so that mobile devices can use this**
- **Realistic chat buttons (like close, minimize, etc.)**

(Stuff in bold is important or new)


This app uses Rails 4 with Ruby version 2.1.2. It is available for testing at blogger-243.herokuapp.com. 
